...
if __name__ == "__main__":
    ...
    num_classes += 1
    anchors = get_anchors(input_shape, anchors_size,aspect_ratios)
    ...
    #     if isinstance(layer, DepthwiseConv2D) or isinstance(layer, Conv2D) or isinstance(layer, Dense):
    #             layer.add_loss(l2(weight_decay)(tf.convert_to_tensor(layer.get_weights())))
    #------------------------------------------------------#
